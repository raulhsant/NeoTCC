...
Os circuitos serão expostos nas figuras~\ref{fig:sys_cuk_conv_bip} a ~\ref{fig:sys_cuk_int_uni} e no anexo~\ref{anex:circ_images}, com maior qualidade.
...
\end{figure}
% \subsubsection{Conversor Ćuk Entrelaçado de Duas Fases com Inversor VSI Bipolar}
% \begin{figure}[htb]%
% 	\begin{center}%
% 		\includegraphics[width=0.55 \linewidth]{lcl_filter_psim}
% 		\caption{Filtro LCL implementado}
% 		\label{fig:sys_cuk_ent_bip}
% 	\end{center}
% \end{figure}
% \subsubsection{Conversor Ćuk Integrado com Inversor VSI Bipolar}
% \begin{figure}[htb]%
% 	\begin{center}%
% 		\includegraphics[width=0.55 \linewidth]{lcl_filter_psim}
% 		\caption{Filtro LCL implementado}
% 		\label{fig:sys_cuk_int_bip}
% 	\end{center}
% \end{figure}
% \subsubsection{Conversor Ćuk Convencional com Inversor VSI Unipolar}
% \begin{figure}[htb]%
% 	\begin{center}%
% 		\includegraphics[width=0.55 \linewidth]{lcl_filter_psim}
% 		\caption{Filtro LCL implementado}
% 		\label{fig:sys_cuk_conv_unip}
% 	\end{center}
% \end{figure}
% \subsubsection{Conversor Ćuk Entrelaçado de Duas Fases com Inversor VSI Unipolar}
% \begin{figure}[htb]%
% 	\begin{center}%
% 		\includegraphics[width=0.55 \linewidth]{lcl_filter_psim}
% 		\caption{Filtro LCL implementado}
% 		\label{fig:sys_cuk_ent_unip}
% 	\end{center}
% \end{figure}
% \subsubsection{Conversor Ćuk Integrado com Inversor VSI Unipolar}
% \begin{figure}[htb]%
% 	\begin{center}%
% 		\includegraphics[width=0.55 \linewidth]{lcl_filter_psim}
% 		\caption{Filtro LCL implementado}
% 		\label{fig:sys_cuk_int_unip}
% 	\end{center}
% \end{figure}
...
Nessa seção são apresentados os resultados apresentados por cada combinação de componentes estudada.
...
\chapter{Circuitos dos Inversores Implementados no PSIM}
