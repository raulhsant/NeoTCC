...
\begin{table}[htbp]
	\centering
		...
		\begin{tabular}{l|c|c|c|}
				...
				\multicolumn{1}{|l|}{\cellcolor[HTML]{C0C0C0}\textbf{Tensão média na saída do conversor}}     & -      & -      & -179,91V	\\ \hline
				\multicolumn{1}{|l|}{\cellcolor[HTML]{C0C0C0}\textbf{Tensão de ripple na saída do conversor}} & -      & -      & 0,22V   	\\ \hline
