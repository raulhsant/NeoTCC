...
% O desenvolvimento de um sistema para fontes fotovoltaicas conectadas a rede elétrica com microinversores baseados no conversor cuk apresenta Características vantajosas em relação à implementação baseada em inversores de grande porte, mais comum na atualidade. Primeiramente, a utilização dos conversores cuk evita que a corrente de saída do painel fotovoltaico apresente pulsos, 

O desenvolvimento de um sistema para fontes fotovoltaicas conectadas à rede elétrica com microinversores baseados no conversor cuk apresenta vantagens em relação à implementações mais comuns. Uma dessas vantagens é a redução e, até ausência de pulsos na corrente de saída do painel fotovoltaico.
