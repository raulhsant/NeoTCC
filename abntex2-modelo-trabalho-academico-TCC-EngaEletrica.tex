...
\begin{figure}[H]%
	\centering%
		\includegraphics[width=0.70 \linewidth]{vsi_bipolar_psim_circ}
...
\begin{figure}[H]%
	\centering%
		\includegraphics[width=0.70 \linewidth]{vsi_unipolar_psim_circ}
...
\begin{figure}[H]%
	\captionsetup{justification=centering}
	\centering
		\includegraphics[width=0.7 \linewidth]{conv_Vo_10Io_comp_unip}
...
\begin{figure}[H]%
	\captionsetup{justification=centering}
	\centering
		\includegraphics[width=0.7 \linewidth]{integ_Vo_10Io_comp}
...
\begin{table}[H]
	...
	\caption{Valores obtidos para o conversor cuk integrado com inversor bipolar}
...
\begin{figure}[H]%
	\captionsetup{justification=centering}
	\centering
		\includegraphics[width=0.7 \linewidth]{integ_Vo_10Io_comp_unip}
		\caption{Sinais de saída obtidos para o conversor cuk integrado com inversor unipolar}
...
\begin{table}[H]
	...
	\caption{Valores obtidos para o conversor cuk integrado com inversor unipolar}
