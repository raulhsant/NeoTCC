	...
	\centering
	 ...
	 \label{tab:conv_cuk_results}
		\resizebox{0.5\linewidth}{!}{%
				...
				\textbf{Oscilação de corrente em $L1$}        			& 0,91A    \\ \hline
				\textbf{Oscilação de corrente em $L2$}        			& 0,10A    \\ \hline
...
\begin{table}[htbp]
	...
	\label{tab:inter_cuk_results}
		...
		\begin{tabular}{l|c|c|c|}
				...
				\multicolumn{1}{|l|}{\cellcolor[HTML]{F0F0F0}\textbf{Oscilação de corrente em $L_{X1}$}}         & 0,91A  & 0,90A  & -					\\ \hline
				\multicolumn{1}{|l|}{\cellcolor[HTML]{F0F0F0}\textbf{Oscilação de corrente em $L_{X2}$}}         & 0,10A  & 0,10A  & -					\\ \hline
				...
				\multicolumn{1}{|l|}{\cellcolor[HTML]{F0F0F0}\textbf{Oscilação de corrente na entrada}}          & -      & -      & 0,74A   	\\ \hline
...
\begin{figure}[htb]%
	...
	\centering
		...
		\caption{Oscilação de corrente no indutores $L_{11}$ e $L_{21}$ do conversor cuk entrelaçado de duas fases}
...
\begin{table}[H]
	...
	\resizebox{\textwidth}{!}{%
		...
		\hline
		\rowcolor[HTML]{F0F0F0} 
		\textbf{Corrente de saída eficaz} & \textbf{Oscilação de corrente}   & \textbf{Tensão de saída eficaz} & \textbf{Tensão de Ripple}   & \textbf{Potência de saída}    & \textbf{Rendimento}   & \textbf{THD}                \\ \hline
...
\begin{figure}[H]%
	...
	\centering
		...
		\caption{Irradiância incidente no painel (a), tensões de entrada e saída (b) e correntes de entrada e saída (c) para o inversor cuk convencional bipolar com variação de irradiância}
...
\begin{figure}[H]%
	...
	\centering
		...
		\caption{Irradiância incidente no painel (a), tensões de entrada e saída (b) e correntes de entrada e saída (c) para o inversor cuk convencional unipolar com variação de irradiância}
...
\begin{figure}[H]%
	...
	\centering
		...
		\caption{Irradiância incidente no painel (a), tensões de entrada e saída (b) e correntes de entrada e saída (c) para o inversor cuk entrelaçado bipolar com variação de irradiância}
...
\begin{figure}[H]%
	...
	\centering
		...
		\caption{Irradiância incidente no painel (a), tensões de entrada e saída (b) e correntes de entrada e saída (c) para o inversor cuk entrelaçado unipolar com variação de irradiância}
...
\begin{figure}[H]%
	...
	\centering
		...
		\caption{Irradiância incidente no painel (a), tensões de entrada e saída (b) e correntes de entrada e saída (c) para o inversor cuk integrado bipolar com variação de irradiância}
...
\begin{figure}[H]%
	...
	\centering
		...
		\caption{Irradiância incidente no painel (a), tensões de entrada e saída (b) e correntes de entrada e saída (c) para o inversor cuk integrado unipolar com variação de irradiância}
...
\begin{table}[htb]
	\centering
	\captionsetup{justification=centering}
	\caption{Resultados de rendimento e qualidade das tensões e correntes de obtidas para os conversores propostos}
