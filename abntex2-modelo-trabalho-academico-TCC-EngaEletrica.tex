...
\begin{table}[!ht]
	\centering
		\resizebox{0.4\textwidth}{!}{%
				...
				\hline
				\textbf{Corrente média em \emph{L1}}            & 9,22A    \\ \hline
				\textbf{Corrente de ripple em \emph{L1}}        & 0,92A    \\ \hline
				\textbf{Corrente de ripple em \emph{L2}}        & 0,10A    \\ \hline
				\textbf{Tensão de ripple em \emph{C1}}          & 0,94V    \\ \hline
				\textbf{Tensão média na saída do conversor}     & -179,91V \\ \hline
				\textbf{Tensão de ripple na saída do conversor} & 0,53V    \\ \hline
...
\begin{figure}[]%
	\centering
		...
		\caption{Corrente de ripple no indutor \emph{L1}}
...
\begin{figure}[]%
	\centering
		...
		\caption{Corrente de ripple no indutor \emph{L2}}
