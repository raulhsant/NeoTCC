...
\section{Projeto dos Conversores CC/CC} \label{cap:project}
...
\begin{table}[htbp]
	\centering
		...
		\begin{tabular}{l|c|c|c|}
				...
				\multicolumn{1}{|l|}{\cellcolor[HTML]{C0C0C0}\textbf{Corrente média na entrada}}              & -      & -      & 9,23A			\\ \hline
				\multicolumn{1}{|l|}{\cellcolor[HTML]{C0C0C0}\textbf{Corrente de ripple na entrada}}          & -      & -      & 0,72A   	\\ \hline
...
Neste capítulo são apresentados os conjuntos formados a partir da conexão dos circuitos dimensionados no capítulo~\ref{cap:project}.


\section{Conjuntos Painel-Conversor CC/CC-Inversor-Filtro}

Nesse capítulo são apresentados os circuitos dos sistemas compostos pela 
conexão do painel fotovoltaico aos conversores projetados nas seções~\ref{sec:met_conv_cc} e \ref{sec:met_conv_integ}, com o chaveamento controlado pelo algoritmo de MPPT (seção~\ref{sec:met_mppt}), interligados aos inversores e ao filtro das seções
~\ref{sec:met_conv_cc_ca} e \ref{sec:met_filt}, respectivamente.
...
\begin{table}[H]
	...
	\resizebox{\textwidth}{!}{%
		...
		\multicolumn{1}{|c|}{$2,26 A$}      & \multicolumn{1}{c|}{20,21 mA} & \multicolumn{1}{c|}{$126,62 V$}   & \multicolumn{1}{c|}{$1,13 V$} & \multicolumn{1}{c|}{$286,31 W$} & \multicolumn{1}{c|}{$95,44\%$} & \multicolumn{1}{c|}{$1,20\%$} \\ \hline
		\end{tabular}%
	}
...
\begin{table}[H]
	...
	\resizebox{\textwidth}{!}{%
		...
		\rowcolor[HTML]{C0C0C0} 
		\textbf{Corrente de saída eficaz} & \textbf{Corrente de ripple}   & \textbf{Tensão de saída eficaz} & \textbf{Tensão de Ripple}   & \textbf{Potência de saída}    & \textbf{Rendimento}   & \textbf{THD}                \\ \hline
		\multicolumn{1}{|c|}{$2,26 A$}      & \multicolumn{1}{c|}{$2,99 mA$} & \multicolumn{1}{c|}{$126,32 V$}   & \multicolumn{1}{c|}{$0,17 V$} & \multicolumn{1}{c|}{$284,93 W$} & \multicolumn{1}{c|}{$94,98\%$} & \multicolumn{1}{c|}{$1,18\%$} \\ \hline
		\end{tabular}%
	}
...
\begin{table}[H]
	...
	\resizebox{\textwidth}{!}{%
		...
		\rowcolor[HTML]{C0C0C0} 
		\textbf{Corrente de saída eficaz} & \textbf{Corrente de ripple}   & \textbf{Tensão de saída eficaz} & \textbf{Tensão de Ripple}   & \textbf{Potência de saída}    & \textbf{Rendimento}   & \textbf{THD}                \\ \hline
		\multicolumn{1}{|c|}{$2,27 A$}      & \multicolumn{1}{c|}{$9,47 mA$} & \multicolumn{1}{c|}{$126,94 V$}   & \multicolumn{1}{c|}{$0,53 V$} & \multicolumn{1}{c|}{$287,73 W$} & \multicolumn{1}{c|}{$95,91\%$} & \multicolumn{1}{c|}{$1,02\%$} \\ \hline
		\end{tabular}%
	}
...
\begin{table}[H]
	...
	\resizebox{\textwidth}{!}{%
		...
		\rowcolor[HTML]{C0C0C0} 
		\textbf{Corrente de saída eficaz} & \textbf{Corrente de ripple}   & \textbf{Tensão de saída eficaz} & \textbf{Tensão de Ripple}   & \textbf{Potência de saída}    & \textbf{Rendimento}   & \textbf{THD}                \\ \hline
		\multicolumn{1}{|c|}{$2,27 A$}      & \multicolumn{1}{c|}{$2,98 mA$} & \multicolumn{1}{c|}{$126,91 V$}   & \multicolumn{1}{c|}{$0,16 V$} & \multicolumn{1}{c|}{$287,59 W$} & \multicolumn{1}{c|}{$95,86\%$} & \multicolumn{1}{c|}{$1,01\%$} \\ \hline
		\end{tabular}%
	}
	\caption{Valores obtidos para o conversor cuk entrelaçado de duas fases com inversor unipolar}
...
\begin{table}[H]
	...
	\resizebox{\textwidth}{!}{%
		...
		\rowcolor[HTML]{C0C0C0} 
		\textbf{Corrente de saída eficaz} & \textbf{Corrente de ripple}   & \textbf{Tensão de saída eficaz} & \textbf{Tensão de Ripple}   & \textbf{Potência de saída}    & \textbf{Rendimento}   & \textbf{THD}                \\ \hline
		\multicolumn{1}{|c|}{$2,24 A$}      & \multicolumn{1}{c|}{$7,57 mA$} & \multicolumn{1}{c|}{$125,64 V$}   & \multicolumn{1}{c|}{$0,42 V$} & \multicolumn{1}{c|}{$281,87 W$} & \multicolumn{1}{c|}{$93,96\%$} & \multicolumn{1}{c|}{$25,53\%$} \\ \hline
		\end{tabular}%
	}
...
\begin{table}[H]
	...
	\resizebox{\textwidth}{!}{%
		...
		\rowcolor[HTML]{C0C0C0} 
		\textbf{Corrente de saída eficaz} & \textbf{Corrente de ripple}   & \textbf{Tensão de saída eficaz} & \textbf{Tensão de Ripple}   & \textbf{Potência de saída}    & \textbf{Rendimento}   & \textbf{THD}                \\ \hline
		\multicolumn{1}{|c|}{$2,27 A$}      & \multicolumn{1}{c|}{$2,86 mA$} & \multicolumn{1}{c|}{$127,07 V$}   & \multicolumn{1}{c|}{$0,16 V$} & \multicolumn{1}{c|}{$288,33 W$} & \multicolumn{1}{c|}{$96,11\%$} & \multicolumn{1}{c|}{$3,07\%$} \\ \hline
		\end{tabular}%
	}
...
% \begin{figure}[htb]
% 	\centering
% 	% \includegraphics[angle=90, scale=0.5]{comp_conv_circ_clean}
% 	\rotatebox{90}{\includegraphics[width=0.9\textheight]{comp_conv_circ_clean}}
% 	\caption{test}	
% \end{figure}

% \begin{figure}[p]
% 	\makebox[\linewidth]{
% 			\includegraphics[width=1.3\linewidth]{comp_conv_circ_clean}
% 	}
